...
export default function Templates() {
    ...
    return (
        <div className="bg-gray-200 dark:bg-gray-800 flex sm:flex-col items-center justify-between sm:justify-center overflow-y-scroll rounded-t-md w-full sm:py-4">
