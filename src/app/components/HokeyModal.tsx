...
export default function HotkeyModal({setShowModal}: HotkeyModalProps) {
    ...
    return (
        <div className="fixed top-0 left-0 w-[100vw] h-[100vh] z-10" >
            ...
            <div className="flex flex-col px-8 py-8 fixed top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 z-30 bg-slate-300 min-w-[300px] min-h-[250px] w-[400px] h-[300px] max-w-[500px] max-h-[400px] rounded-lg shadow-xl drop-shadow-xl">
                <div className="mb-auto">
                    <p className="flex flex-row text-lg mb-auto">
                ...
                <div className="flex items-center justify-center">
                    <button
                        ...
                        className="text-lg bg-red-400 px-3 py-[2px] rounded-md shadow-md drop-shadow-md hover:scale-105 active:scale-95 transition-all duration-150"
                    >
                        close
                    </button>
                </div>
