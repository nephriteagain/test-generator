import { test,  action, question, unit, unitType, actions, choice, matchingUnit, delete_matching_choice_action } from "../../types/types";
...
describe('deleteMatchingChoice', () => {
    ...
    const action : delete_matching_choice_action = {
